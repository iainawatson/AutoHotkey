...
;retained old messing code, but greek letter input is now just normal, fixed in latex EXCEPT for µ!
...
+^8:: ; SHIFT+CTRL+8 hotkey to insert Greek ε
BlockInput, On
SendInput, ε
BlockInput, Off
return
